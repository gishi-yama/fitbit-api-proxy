...
**生成AIを利用した場合は、レポート課題に記述する必要がある（後述）ので、生成AIに送信したプロンプトと回答を記録しておくこと**。
...
1. 完成したプログラムを、授業ページのレポートBOXから提出しなさい。
2. プログラムを実行した上で、次ページの指示に沿ったレポート課題を作成し、こちらも授業ページのレポートBOXから提出しなさい。
...
先述の通り、生成AIを利用した場合は、（レポート部分に限らず、プログラム部分でも）使用した箇所と、その際のプロンプトを報告すること。
